...
namespace circuit_generator
{
    public partial class Nagruzka
    {
        ...
        public string Harakter1 { get; set; } // Характер нагрузки
        public string TypeNetwork1 { get; set; } // Тип сети
        public string Type1 { get; set; } // Тип нагрузки промежуточная/конечная
